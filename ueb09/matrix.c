 ...
 ***************************************************************************/
extern int const MaxRows, MaxColumns = 8;
...
int getNumberOfRows(int Row, int Col, int MatrixNo)
{
   int NoRow;
   POSITION(Row, Col);
   printf("Geben Sie bitte die Zeilenanzahl der %i. Matrix ein (1..8):____", MatrixNo);
   scanf("%i", &NoRow);
...
int getNumberOfColumns(int Row, int Col, int MatrixNo)
{
   int NoCol;
   POSITION(Row, Col);
   printf("Geben Sie bitte die Spaltenanzahl der %i. Matrix ein (1..8):", MatrixNo);
   scanf("%i", &NoCol);
